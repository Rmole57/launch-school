...
--
-- Name: weather; Type: TABLE; Schema: public; Owner: RickMole
--
...
ALTER TABLE public.weather OWNER TO "RickMole";

--
-- Data for Name: weather; Type: TABLE DATA; Schema: public; Owner: RickMole
--
